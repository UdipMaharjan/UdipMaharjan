...
# ===========================================================================
HOST = "udip"   # shown as  udip@github  in the header

ROWS = [
    ("host",),
    ("kv", "Focus", "AI, Machine Learning, Data Science"),
    ("kv", "Building", "Lekhantra - AI Study Assistant"),
    ("kv", "Edu", "BSc (Hons) Computing w/ AI, Islington '24-"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, Java, C, SQL, JavaScript"),
    ("kv", "AI / ML", "NumPy, Pandas, Scikit-learn, OpenAI API"),
    ("kv", "Web", "HTML, CSS, JavaScript, FastAPI"),
